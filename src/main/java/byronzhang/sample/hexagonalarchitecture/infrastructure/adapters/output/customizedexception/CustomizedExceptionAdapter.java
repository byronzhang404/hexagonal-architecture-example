package byronzhang.sample.hexagonalarchitecture.infrastructure.adapters.output.customizedexception;
...
import byronzhang.sample.hexagonalarchitecture.infrastructure.adapters.output.customizedexception.data.response.ExceptionResponse;
